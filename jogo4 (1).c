    ...
    while(opcao!=1 || opcao!=2 || opcao!=3)
    {
        ...
        if(opcao==1)
        {
            ...
            while(t[2].topo!=dificuldade-1 || t[1].topo!=dificuldade-1)
            {
                ...
                while((opcao3<1 || opcao3>3) || (t[opcao3-1].topo)==-1)
                {
        ...
        {
            system("cls");
            printf("Torre de Hanói é um 'quebra-cabeça' que consiste \nem uma base contendo três pinos, em um dos quais\nsão dispostos alguns discos uns sobre os outros, \nem ordem crescente de diâmetro, de cima para \nbaixo. O problema consiste em passar todos os \ndiscos de um pino para outro qualquer, nusando um \ndos pinos como auxiliar, de maneira que um disco\nmaior nunca fique em cima de outro menor em nenhuma\nsituação. O número de discos pode variar sendo\nque o mais simples contém apenas três.");
            printf("\n\n");
